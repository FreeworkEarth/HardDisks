...
# Load data
print("Loading data...")
data = np.loadtxt('wall_oscillation.dat', skiprows=1)
step = data[:, 0]
wall_x = data[:, 1]
wall_vx = data[:, 2]
n_left = data[:, 3]
...
plt.tight_layout()
plt.savefig('wall_dynamics_full.png', dpi=200, bbox_inches='tight')
plt.savefig('wall_dynamics_full.pdf', bbox_inches='tight')
print("\nSaved: wall_dynamics_full.png and wall_dynamics_full.pdf")
plt.close()
...
plt.tight_layout()
plt.savefig('wall_fft_analysis.png', dpi=200, bbox_inches='tight')
plt.savefig('wall_fft_analysis.pdf', bbox_inches='tight')
print("Saved: wall_fft_analysis.png and wall_fft_analysis.pdf")
plt.close()
...
plt.tight_layout()
plt.savefig('wall_oscillations_zoom.png', dpi=200, bbox_inches='tight')
plt.savefig('wall_oscillations_zoom.pdf', bbox_inches='tight')
print("Saved: wall_oscillations_zoom.png and wall_oscillations_zoom.pdf")
plt.close()
...
print("="*60)
print("  1. wall_analysis.png/pdf - Quick FFT analysis")
print("  2. wall_dynamics_full.png/pdf - Comprehensive dynamics")
print("  3. wall_fft_analysis.png/pdf - Detailed FFT analysis")
print("  4. wall_oscillations_zoom.png/pdf - First 5 periods")
print("="*60)
