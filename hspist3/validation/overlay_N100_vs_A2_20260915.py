...
P = T.PLOTS
A1 = T.plot_path(os.environ.get("HD_A1_CSV", "260919_A1v2_final_cs_vs_eta.csv"))
...
a1 = [(float(r["eta"]), float(r["c_s"]), float(r.get("c_s_err_scaled") or r["c_s_scatter_mass"])) for r in csv.DictReader(open(A1))]
by = defaultdict(list)
