...
\paragraph{DERIVATION --- does Eq.~\eqref{eq:gp51} itself change for hard disks?} Argued no at
leading order, and tagged OPEN until the data say. The drift is a ratio of the asymmetric momentum
...
resonance is $2.2\times$ broader} ($\Gamma_{\mathrm{implied}} = 0.72$, $0.76$). Reported as a
