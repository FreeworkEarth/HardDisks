...
$19$--$57\,\%$. The residual is therefore entirely in the transient, and it is the acoustic pulse:
the model is undamped, so it already gives the largest overshoot a linear system can. Closing it
needs the wall's radiation reaction in the drive.
