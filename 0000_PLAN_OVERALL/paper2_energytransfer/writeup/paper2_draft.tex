...
\emph{Passed on $\epsilon_{\mathrm{settled}}$ (v6).} Geometry C: one gas of 100 disks drives a spring-loaded wall through a
...
\textbf{Status: passed on $\epsilon_{\mathrm{settled}}$.} The ledger closes (median
$4.6\times10^{-10}$, 593/600 below $10^{-8}$). The observable is the wall's settled displacement,
pooled over five cells with validated windows. A parameter-free one-degree-of-freedom model
$M\ddot s = F_{\mathrm{ad}}(L - x_p + s) - F_{\mathrm{ad}}(L) - k s$ with \emph{bulk}
equation-of-state inputs predicts it to $+3.6 \pm 0.6\,\%$ ($6.2\sigma$); with the box's own
measured standing force, its Paper-1 sound speed and Level~1's measured adiabat --- all
measurements, none fitted --- the residual is $-0.1 \pm 0.7\,\%$, $0.1\sigma$. The transient
excess reported earlier was a peak statistic, reproduced by a no-push control with no gas driving at
all; the peak is a diagnostic, not a criterion.
