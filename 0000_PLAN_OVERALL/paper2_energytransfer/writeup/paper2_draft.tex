% ##CHRIS 2026-09-19: Paper 2 skeleton, organised as the proof ladder. Levels 0-2 carry the measured
% numbers; Levels 3-6 are headed placeholders with the pass criteria from the plan. Every claim has a
% % TODO-source line naming where the number came from.
...
\title{Where injected work goes in a hard-disk box:\\ a proof ladder for an energy-transfer experiment}
\author{C.\ Haring}
\date{Draft, \today}
...
\begin{center}\includegraphics[width=0.92\linewidth]{260919_demo_geomA.png}\end{center}
...
\section{Level 3 --- can a spring capture it?}
\emph{Not started.} Geometry C: one gas drives a spring-loaded wall.
\textbf{Pass criterion:} $E_{\mathrm{spring,max}}$ agrees with the quasi-static prediction
$\tfrac12 k x_{\mathrm{eq}}^2$ when $\tau_{\mathrm{push}} \gg T_w$ and with
$\frac{k}{k + k_{\mathrm{gas}}}\frac{\Delta p_w^2}{2M}$ when $\tau_{\mathrm{push}} \ll T_w$, each
within $2\sigma$.
% TODO-source: plan 260916 section Level 3
...
\begin{center}\includegraphics[width=0.92\linewidth]{260919_demo_geomD.png}\end{center}
