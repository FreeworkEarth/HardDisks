...
for spec in "0.02 24000 50" "0.03 24000 100" "0.05 17000 90" "0.10 15000 90"; do
...
wait
echo "done: $(ls $P/u*/tr_*.csv 2>/dev/null | wc -l | tr -d ' ')/330; aborts $(cat $P/u*/run.log | grep -c ABORTING); health $(cat $P/u*/run.log | grep -c EDMD-HEALTH)"
